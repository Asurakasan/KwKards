...
<link rel="stylesheet" href="Connexion.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-7c9b"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-image u-section-1" id="sec-8764" data-image-width="3000" data-image-height="1000">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h4 class="u-text u-text-custom-color-1 u-text-1">
          <span class="u-text-custom-color-2">#</span>CONNEXION
        </h4>
        <div class="u-border-5 u-border-custom-color-1 u-line u-line-horizontal u-line-1"></div>
      </div>
    </section>
    <section class="u-clearfix u-custom-color-1 u-section-2" id="sec-2291">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-align-center u-container-style u-custom-color-3 u-group u-radius-15 u-shape-round u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h2 class="u-align-center u-text u-text-default u-text-1">
              <span class="u-text-custom-color-2" style="font-weight: 700;">CONNEXION</span>
              <br>
            </h2>
            <div class="u-border-8 u-border-custom-color-1 u-line u-line-horizontal u-line-1"></div>
            <div class="u-align-center u-form u-form-1">
              <form method="POST" source="custom" name="form" style="padding: 10px;">
                <div class="u-form-group u-form-name">
                  <label for="name-39a0" class="u-form-control-hidden u-label"></label>
                  <input type="email" placeholder="Votre Email !" id="lemail" name="lemail" class="u-border-4 u-border-custom-color-2 u-input u-input-rectangle u-radius-18 u-white" required="">
                </div>
				</br>
                <div class="u-form-group u-form-group-2">
                  <label for="text-437d" class="u-form-control-hidden u-label"></label>
                  <input type="password" placeholder="Votre mot de passe !" id="lpassword" name="lpassword" class="u-border-4 u-border-custom-color-2 u-input u-input-rectangle u-radius-18 u-white" required="required">
                </div>
                <div class="u-align-center u-form-group u-form-submit">
                  <a  class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-1 u-radius-10 u-btn-1">CONNEXION</a>
				  <input type="submit" name="formlogin" id="formlogin" value="CONNEXION"  class="u-form-control-hidden">
                </div>
				<?php include 'login.php'; ?>
              </form>
            </div>
            <p class="u-align-center u-text u-text-default u-text-2">Je n'ai pas de compte.&nbsp;</p>
            <p class="u-align-center u-text u-text-default u-text-3">
              <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-custom-color-2 u-btn-2" href="Inscription.php" data-page-id="849228040">S'inscrire-ici !</a>
            </p>
