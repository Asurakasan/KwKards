  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-7c9b"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-custom-color-1 u-section-2" id="sec-99c9">
      <div class="u-clearfix u-sheet u-sheet-1">
		...
		$UScore = 0;
		$IAScore = 0; 
		$_SESSION['Uscore'] = $UScore;
		$_SESSION['IAScore'] = $IAScore;
		if(isset($_POST['upload'])){

		$req=$db->prepare("UPDATE USER SET koins = :koins, xp = :xp 
							WHERE  u_id = :id");
		$req->execute(['koins' => $_SESSION['koins'],'xp' => $_SESSION['xp'], 'id' => $_SESSION['u_id']]);
		
		?>
							
		<meta http-equiv="refresh" content="0;url=Fight1.php">
		...
		<form method="post">
		<input type="submit" value="Start !" id="upload" name="upload" class="u-text-custom-color-2">
		</div>
				</br>
				</br>
				</br>
